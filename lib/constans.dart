...
const kBottomContainersHeight = 80.0;
const kActiveCardColour = Color(0xFF101427);
const kInactiveCardColour = Color(0xFF1D1F33);
const kColourOfBottom = Color(0xFFEB1555);
...
const kResultTextStyle = TextStyle(color: Color(0xFF24D876),fontSize: 24.0, fontWeight: FontWeight.bold);
